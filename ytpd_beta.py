...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.url_fetching_data_label.setGeometry(QtCore.QRect(560, 330, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setItalic(True)
        ...
        self.enter_playlist_url_label_2.setGeometry(QtCore.QRect(120, 379, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setUnderline(False)
...
"")
        ...
        self.download_time = QtWidgets.QLabel(self.centralwidget)
        self.download_time.setGeometry(QtCore.QRect(250, 450, 171, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setUnderline(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.download_time.setText(_translate("MainWindow", "Download time: "))
